        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="container-ss-station d-none">
                    <button class="btn btn-primary btn-block btn-lg download-comb-stock" title="Generar información en Hoja de Cálculo"><span class="glyphicon glyphicon-download-alt"></span> Hoja de Cálculo</button>
                </div>               
                <div class="row">&nbsp;</div>
