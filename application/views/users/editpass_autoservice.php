    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">                
                ...
                <form method="post" action="<?php echo base_url() ?>index.php/users/updatepass_autoservice"> <!-- novalidate -->
                    <div class="col-lg-12 form-group">
                        <label>Contrase&ntilde;a Actual:</label>
                        <input type="password" name="password_current" value="" id="password_current" class="form-control" required> <!-- required -->                        
                    </div>
                    <div class="col-lg-12 form-group">
